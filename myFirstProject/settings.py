...
# EMAIL_HOST = 'your_smtp_host'  # e.g., 'smtp.gmail.com', 'smtp.mailtrap.io'
# EMAIL_PORT = 587  # Common ports: 587 (TLS), 465 (SSL)
# EMAIL_USE_TLS = True  # Set to True for TLS encryption (recommended for port 587)
# EMAIL_USE_SSL = False # Set to True for SSL encryption (recommended for port 465), ensure EMAIL_USE_TLS is False
